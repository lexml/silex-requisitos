%% abtex2-modelo-relatorio-tecnico.tex, v1.9 laurocesar
...
% verso e anverso:
\documentclass[a4paper,11pt,openright,twoside,brazil]{abntex2} 
...
%  \graphicspath{{imagens/pb/}}		% imagens preto e branco
...
Jurídica, elaborado no âmbito do Comitê Gestor de Informação do Portal LexML (CGLEXML).}
% ---
