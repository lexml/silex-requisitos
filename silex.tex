...
\begin{tabelarequisito}{Requisitos Gerais do SILEX}{tab-requisitos-gerais}
  ...
  \requisito{RGS4}{O}{O SILEX permite a inclusão de alertas e notas
  explicativas que registrem possíveis inconsistências dos dados descritivos
  das unidades de informação ou nos seus relacionamentos.
   \par
   \emph{Por exemplo: pode-se incluir uma nota explicativa indicando que uma
   norma foi publicada com a duplicação de um artigo; pode-se incluir um alerta
   de que uma norma alterou as ocorrências de uma expressão em outra norma.} }
...
% ---
\begin{landscape}
\input{apendice_tabelas_relacionamento}
\end{landscape}
% ---
